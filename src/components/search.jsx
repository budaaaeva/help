    ...
    render() {
        return <div className="row">
            <div className="col s12">
                <p className="white-text">Only the most interesting here</p>
                <div className="input-field">
                    ...
                    />
                    <button className="btn search-button deep-purple darken-4" onClick={() => this.props.searchMovies(this.state.search, this.state.type)}> Search </button>
                </div>
                <div>
                    <label>
